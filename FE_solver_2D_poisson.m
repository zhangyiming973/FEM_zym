...
if a==1
    ...
    A = A_xx + A_yy;
elseif a==2
    % Term 1: c11 * du/dx * dv/dx
    % Trial dx=1, Test dx=1
    A_11 = assemble_matrix_2D(matrix_size, gauss_type, c_input.c11, ...
                              P_mesh, T_mesh, T_trial, T_test, ...
                              trial_basis_type, 1, 0, ... 
                              test_basis_type,  1, 0);

    % Term 2: c12 * du/dy * dv/dx  <-- 注意交叉项
    % Trial dy=1 (对 u 求导), Test dx=1 (对 v 求导)
    A_12 = assemble_matrix_2D(matrix_size, gauss_type, c_input.c12, ...
                              P_mesh, T_mesh, T_trial, T_test, ...
                              trial_basis_type, 0, 1, ... 
                              test_basis_type,  1, 0);

    % Term 3: c21 * du/dx * dv/dy  <-- 注意交叉项
    % Trial dx=1, Test dy=1
    A_21 = assemble_matrix_2D(matrix_size, gauss_type, c_input.c21, ...
                              P_mesh, T_mesh, T_trial, T_test, ...
                              trial_basis_type, 1, 0, ... 
                              test_basis_type,  0, 1);

    % Term 4: c22 * du/dy * dv/dy
    % Trial dy=1, Test dy=1
    A_22 = assemble_matrix_2D(matrix_size, gauss_type, c_input.c22, ...
                              P_mesh, T_mesh, T_trial, T_test, ...
                              trial_basis_type, 0, 1, ... 
                              test_basis_type,  0, 1);
